...
public class ReservationControllerTest {
    ...
    public void getReservations() throws Exception {
        ...
        given(reservationService.getRoomReservationsForDate("1970-01-01")).willReturn(mockReservationsList);
